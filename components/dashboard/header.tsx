...
export function Header({
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-border bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      {/* Main row: logos, title, and controls */}
      <div className="flex w-full items-center justify-between gap-3 px-4 py-3 sm:px-6 sm:py-0 sm:h-20">
      ...
      {/* Mobile-only: Dublin Clock on second row */}
      <div className="flex items-center justify-center gap-3 border-t border-border px-4 py-2 sm:hidden">
