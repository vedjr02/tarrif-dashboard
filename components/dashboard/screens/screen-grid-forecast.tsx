      ...
      <Card className="flex-1">
        ...
        <CardContent className="p-2 sm:p-4">
              ...
              (() => {
                ...
                return next12Hours.map((hour, idx) => {
                  ...
                  return (
                    <div
                      key={hour.timestamp}
                      className={`flex flex-col items-center gap-1 p-2 rounded-lg min-w-[70px] ${
                    ...
                    >
                      ...
                      {/* Wind Speed & Gusts */}
                      {windPoint && (
                        <div className="flex flex-col items-center gap-0.5 mt-1 pt-1 border-t border-border/50 w-full">
                          <div className="flex items-center gap-1">
                            <Wind className="h-3 w-3 text-primary" />
                            <span className="text-xs font-semibold">{Math.round(windPoint.windSpeed)}</span>
                          </div>
                          <span className="text-[10px] text-muted-foreground">
                            Gust: {Math.round(windPoint.windGusts)}
                          </span>
                        </div>
                      )}
                      
                      {hour.precipitation > 0 && (
                        <span className="text-[10px] text-blue-500">{hour.precipitation.toFixed(1)}mm</span>
                      )}
                    </div>
                  )
                })
          ...
          <div className="flex justify-center gap-4 mt-2 text-xs text-muted-foreground">
            ...
            <span className="flex items-center gap-1"><Wind className="h-3 w-3" /> Wind (km/h)</span>
